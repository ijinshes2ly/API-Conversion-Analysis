...
print("\n트래픽 소스별 평균 전환율 집계:")
print(traffic_conversion_summary)
...
plt.bar(traffic_source_summary["Traffic_Source"], traffic_source_summary["Visitors"],
...
# 트래픽 소스별 평균 전환율
plt.figure(figsize=(8, 5))
plt.bar(traffic_conversion_summary["Traffic_Source"], traffic_conversion_summary["Conversion_Rate"],
        color=['blue', 'green', 'red', 'purple', 'orange'])
plt.xlabel("Traffic Source")
